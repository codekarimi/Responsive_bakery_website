...
navLink.forEach(n => n.addEventListener('click', linkAction)) //instead of addind onclick() function on all elements
...
sr.reveal('.favorite--card img' , { interval:100,rotate: {z: 30}, distance:0 })
